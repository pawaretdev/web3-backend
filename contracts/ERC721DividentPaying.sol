    ...
    IERC721DividendPaying
{
    ...
    function withdrawableDividendOf(address owner)
        public
        view
        override
        returns (uint256)
    ...
    function accumulativeDividendOf(address owner)
        public
        view
        override
        returns (uint256)
    ...
    function withdrawnDividendOf(address owner)
        public
        view
        override
        returns (uint256)
